...
<html>
  <head>
    ...
    <!-- Font Awesome CSS-->
    <link rel="stylesheet" href="{{asset('assets/frontendvendor/font-awesome/css/font-awesome.min.css')}}">
    <!-- Google fonts - Roboto -->
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Roboto:100,300,400,700">
    <!-- owl carousel-->
    <link rel="stylesheet" href="{{asset('assets/frontendvendor/owl.carousel/assets/owl.carousel.css')}}">
    <link rel="stylesheet" href="{{asset('assets/frontendvendor/owl.carousel/assets/owl.theme.default.css')}}">
    <!-- theme stylesheet-->
    <link rel="stylesheet" href="{{asset('assets/frontendcss/style.default.css" id="theme-stylesheet')}}">
    <!-- Custom stylesheet - for your changes-->
    <link rel="stylesheet" href="{{asset('assets/frontendcss/custom.css')}}">
    <!-- Favicon-->
    <link rel="shortcut icon" href="{{asset('assets/frontendfavicon.png')}}">
  ...
  <body>
    ...
    <header class="header mb-5">
      ...
      *** TOPBAR ***
      ...
      <nav class="navbar navbar-expand-lg">
        <div class="container"><a href="{{route('frontend.home')}}" class="navbar-brand home"><img src="{{asset('assets/frontendimg/logo.png')}}" alt="Logo" class="d-none d-md-inline-block"><img src="{{asset('assets/frontendimg/logo-small.png')}}" alt="Logo" class="d-inline-block d-md-none"><span class="sr-only">Obaju - go to homepage</span></a>
          ...
          <div id="navigation" class="collapse navbar-collapse">
            <ul class="navbar-nav mr-auto">
              <li class="nav-item"><a href="{{route('frontend.home')}}" class="nav-link active">Home</a></li>
              @foreach($data['categories'] as $category)
              <li class="nav-item dropdown menu-large">@endforeach<a href="#" data-toggle="dropdown" data-hover="dropdown" data-delay="200" class="dropdown-toggle nav-link">Men<b class="caret">{{$category->title}}</b></a>
                    ...
                    <div class="row">
                      <div class="col-md-6 col-lg-3">
                        ...
                        <ul class="list-unstyled mb-3">
                          ...
                          <li class="nav-item"><a href="detail.html" class="nav-link">{{$subcategory->title}}</a></li>
                          @endif
                          @endforeach
          ...
          <div class="row">
            <div class="col-md-12">
              <div id="main-slider" class="owl-carousel owl-theme">
                <div class="item"><img src="{{asset('assets/frontendimg/main-slider1.jpg')}}" alt="" class="img-fluid"></div>
                <div class="item"><img src="{{asset('assets/frontendimg/main-slider2.jpg')}}" alt="" class="img-fluid"></div>
                <div class="item"><img src="{{asset('assets/frontendimg/main-slider3.jpg')}}" alt="" class="img-fluid"></div>
                <div class="item"><img src="{{asset('assets/frontendimg/main-slider4.jpg')}}" alt="" class="img-fluid"></div>
              </div>
              <!-- /#main-slider-->
            </div>
          </div>
    ...
    *** COPYRIGHT ***
    ...
    <!-- *** COPYRIGHT END ***-->
    <!-- JavaScript files-->
    <script src="{{asset('assets/frontendvendor/jquery/jquery.min.js')}}"></script>
    <script src="{{asset('assets/frontendvendor/bootstrap/js/bootstrap.bundle.min.js')}}"></script>
    <script src="{{asset('assets/frontendvendor/jquery.cookie/jquery.cookie.js')}}"> </script>
    <script src="{{asset('assets/frontendvendor/owl.carousel/owl.carousel.min.js')}}"></script>
    <script src="{{asset('assets/frontendvendor/owl.carousel2.thumbs/owl.carousel2.thumbs.js')}}"></script>
    <script src="{{asset('assets/frontendjs/front.js')}}"></script>
  </body>
</html>
