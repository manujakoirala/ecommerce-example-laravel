            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$d->created_at}}</td>
                        <th><a href="{{route('backend.option.show',$d->id)}}">ViewDetails</a>
                            <a href="{{route('backend.option.edit',$d->id)}}">Edit</a>
                            <form action="{{route('backend.option.destroy',$d->id)}}" method="post">
