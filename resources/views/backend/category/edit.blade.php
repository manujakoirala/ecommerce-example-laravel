            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    @if($data['records']->status==1)
                        <input type="radio" name="status" id="active" value="1" checked>Active<br>
                        <input type="radio" name="status" d="active" value="0"> De-Active<br>
                    @else
                        <input type="radio" name="status" id="active" value="1"> Active<br>
                        <input type="radio" name="status" d="active" value="0" checked> De-Active<br>
                    @endif
                </div>
                <div class="form-group">
